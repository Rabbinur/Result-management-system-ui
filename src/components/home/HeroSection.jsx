    ...
    <>
      <main className="grid grid-cols-1 gap-10 lg:grid-cols-12  items-center justify-between">
        ...
        <section className="col-span-6 lg:leading-[80px]">
          <h1 className="text-[24px] md:text-[36px] lg:text-[46px] text-center lg:text-left capitalize font-semibold">
            Embracing <span className="text-[#00BB35]">Success</span> with Good
            Results
          </h1>

          <p className="text-md md:text-xl text-[#000000] my-5 font-normal text-center lg:text-left">
            A good student turns knowledge into a staircase, each step a
            testament to their relentless pursuit of success.
          </p>


          <div className="max-w-[300px] mx-auto lg:mx-0 mt-6">
            <Link
              to="#"
              className="text-md font-semibold text-white py-3 px-6 rounded-lg 
